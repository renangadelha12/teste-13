...
dados = '1213.txt'
#dados='https://raw.githubusercontent.com/renangadelha12/teste12/main/dall.txt'
#https://raw.githubusercontent.com/renangadelha12/teste/main/dall.txt
...
variavel_analise1 = st.selectbox('Selecione a variável para graficar', variaveis_analise1, index=0, key='variavel_analise1')
parametro_analise = st.selectbox('Selecione a como deseje realizar a plotagem dos dados:', tipos_de_analise, index=0, key='parametro_analise')
